"""
inspired from @itsz_krish_babess @itsz_krish_babess
from ..helpers.utils import _format
Quotes credits: Being Biblical Channel : @itsz_krish_babess
AlenPaulVarghese(@itsz_krish_babess)[hp]
Sing credits :By @itsz_krish_babess
No Logic Pligon for @itsz_krish_babess
\nCoding by Legend @itsz_krish_babess
...
async def _(event):
    ...
    if x == 13:
        await event.edit(
            "[A perfect justifiarankion for breaking a promise...](https://telegra.ph/file/0b8fb8fb729d157844ac9.jpg)",
            link_preview=True,
        )
    if x == 14:
        await event.edit(
    ...
    if x == 27:
        await event.edit(
            "[A justifiarankion for not voting!](https://telegra.ph/file/87d475a8f9a8350d2450e.jpg)",
            link_preview=True,
        )
    if x == 28:
        await event.edit(
...
async def _(event):  # sourcery no-metrics  # sourcery skip: low-code-quality
    ...
    if x == 16:
        await event.edit(
            '`"200 years ago, people would never have guessed that humans in the future would communiaranke by silently tapping on glass."`'
        )
    if x == 17:
        await event.edit(
    ...
    if x == 33:
        await event.edit(
            '`"Humans are designed to learn through experience yet the eduarankion system has made it so we get no experience."`'
        )
    if x == 34:
        await event.edit(
...
async def _(event):  # sourcery no-metrics  # sourcery skip: low-code-quality
    ...
    if x == 18:
        await event.edit(
            r"`\"When researching things to do for your next leisure travel. Include \<loarankion\> tourism scam into your search. All tourist heavy areas will have their own scams. This should not dampen your excitement but heighten your knowledge so your vaarankion will be more enjoyable.\"`"
        )
    if x == 19:
        await event.edit(
    ...
    if x == 25:
        await event.edit(
            "`\"If you're a student planning on your career, look up postings of your dream job, find the skills and qualifiarankions you'll need, then work backwards from there.\"`"
        )
    if x == 26:
        await event.edit(
    ...
    if x == 55:
        await event.edit(
            '`"Buy a small bottle of perfume you have never tried on before going for a vaarankion and use it for while you\'re there. At any point after your vaarankion, you get a sniff of it, it brings back those memories instantly. Because scents are among the most powerful memory triggers."`'
        )
    if x == 56:
        await event.edit(
    ...
    if x == 80:
        await event.edit(
            '`"When filling out appliarankions online, make sure you copy responses which typically take a long time to write, and paste them to a text file. You never know when you could get a server timeout."`'
        )
    if x == 81:
        await event.edit(
...
async def _(event):  # sourcery no-metrics  # sourcery skip: low-code-quality
    ...
    if x == 28:
        await event.edit(
            '`"What are some good and bad things about the eduarankion system in your country?"`'
        )
    if x == 29:
        await event.edit('`"What do you think of online eduarankion?"`')
    if x == 30:
    ...
    if x == 55:
        await event.edit(
            '`"What is the most important change that should be made to your country’s eduarankion system?"`'
        )
    if x == 56:
