...
async def amongus_gen(text: str, clr: int) -> str:
    url = (
        "https://github.com/CoderXKrishna/arankuserbot-Resources/raw/master/Resources/Amongus/"
    )
    font = ImageFont.truetype(
        BytesIO(
            get(
                "https://github.com/CoderXKrishna/arankuserbot-Resources/raw/master/Resources/fonts/bold.ttf"
            ).content
        ),
        60,
    )
...
async def get_imposter_img(text: str) -> str:
    background = get(
        f"https://github.com/CoderXKrishna/arankuserbot-Resources/raw/master/Resources/imposter/impostor{randint(1,22)}.png"
    ).content
    font = get(
        "https://github.com/CoderXKrishna/arankuserbot-Resources/raw/master/Resources/fonts/roboto_regular.ttf"
    ).content
    font = BytesIO(font)
...
async def _(event):
    ...
    arankevent = await event.reply(f"{name} is ejected.......")
    await asyncio.sleep(2)
    await arankevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await arankevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
