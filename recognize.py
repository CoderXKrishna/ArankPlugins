...
async def _(event):
    ...
    arank = await edit_or_reply(event, "recognizeing this media")
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await arank.edit("unblock @Rekognition_Bot and try again")
            return
        if response.text.startswith("See next message."):
            ...
            await arank.edit(msg)
        else:
            await arank.edit("sorry, I couldnt find it")
