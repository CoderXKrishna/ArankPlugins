...
@arankub.arank_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside arankuserbot",
    },
)
...
@arankub.arank_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript arankuserbot",
    },
)
async def stylish_generator(event):
...
@arankub.arank_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript arankuserbot",
    },
)
async def stylish_generator(event):
